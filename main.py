...
class PasswordManager:
    def __init__(self, root):
        ...
        self.style.theme_use("clam")  # You can try "alt", "default", "classic", or "vista"
        ...
        self.website_entry.insert(0, "www.example.com")
    ...
    def update_password_strength(self, *args):
        ...
        self.strength_label.config(text=f"Password Strength: {strength}")  # Fixed typo here
    ...
    def save_password(self):
        """Save the entered details to a file."""
